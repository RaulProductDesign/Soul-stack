...
import { QuestionCard, CategoryType, LayerType, LAYER_NAMES } from "@shared/sheety";
...
export default function Questions() {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        setLoading(true);
        const categoryQuestions = await fetchQuestionsByCategoryAndLayer(categoryType, layerType);
    ...
    <div className="min-h-screen bg-soul-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 pb-20">
        <div className="flex flex-col items-center w-full max-w-sm gap-8">
          ...
          {/* Loading State */}
          {loading && (
            <div className={`w-full h-56 rounded-3xl bg-${categoryColor} shadow-lg p-6 flex items-center justify-center`}>
