          ...
          {!loading && !error && questions.length > 0 && (
            <>
              <div className="relative w-full overflow-hidden">
                ...
                {/* Main Card */}
                <div 
                  className={`relative h-56 rounded-3xl bg-soul-family shadow-lg p-6 flex items-center justify-center transition-all duration-200 ease-in-out ${
                    isAnimating 
                ...
                {isAnimating && (
                  <div 
                    className={`absolute inset-0 h-56 rounded-3xl bg-soul-family shadow-lg p-6 flex items-center justify-center transition-all duration-200 ease-in-out ${
                      animationDirection === 'next' 
                        ? 'transform translate-x-0 opacity-100' 
                        : 'transform -translate-x-0 opacity-100'
                    }`}
