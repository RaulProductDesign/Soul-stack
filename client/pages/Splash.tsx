...
export default function Splash() {
  ...
  useEffect(() => {
    // Auto-navigate to homepage after 2.5 seconds
  ...
  return (
    <div className="min-h-screen bg-soul-background flex flex-col justify-center items-center px-4 gap-3">
      {/* Logo */}
      <div className="flex flex-col items-center gap-4">
        ...
        <h1 className="text-soul-text-subtle font-lora text-6xl font-medium tracking-tight">
          Unlayer
        </h1>
      </div>
      ...
      <div className="text-center space-y-1">
        <p className="text-soul-text-subtle font-lato text-lg font-light">
